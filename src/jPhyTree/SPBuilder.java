...
public class SPBuilder {
	...
	private static final double SUBPOP_PVALUE = VCFConstants.SUBPOP_PVALUE;
	private static final int EDIT_DISTANCE = VCFConstants.EDIT_DISTANCE;
	private DirectedGraph<Integer, Integer> currTree;
	private HashMap<Integer, String> nodeLabels;
	private VCFDatabase vcfDB;

	public SPBuilder(Map<String, Double> mutMap, ArrayList<ArrayList<Integer>> noConflictMatrixPrime, Set<ArrayList<Integer>> conflicts, 
		...
		currTree = assembleGraph(noConflictMatrixPrime, LColFuncMap, mutMap, edgeToCodeMap, nodeLabels, testName);
	...
	private DirectedGraph<Integer, Integer> assembleGraph(ArrayList<ArrayList<Integer>> matrixPrime, 
			HashMap<Integer, Integer> lColFuncMap, Map<String, Double> mutMap, Map<Integer, ArrayList<Integer>> edgeToCodeMap, 
			HashMap<Integer, String> nodeLabels, String testName) {
...
//		System.out.println(edgeToCodeMap.toString());
		...
		Map<String, Double> redEdgeMap = new HashMap<String, Double>(mutMap);
		/**
		 * Taken out for time testing
		 */
...
//		System.out.println("Red Edges Before Checking Size Limits: " + redEdgeMap.toString());
		...
		Map<Integer, Double> subPopCounts = distributeRedEdges(redEdgeMap, edgeToCodeMap, matrixPrime, g);
		/**
		 * Taken out for time testing
		 */
...
//			if (ancestors != null) System.out.println("Ancestors: " + ancestors.toString());
		 ...
		 */
//		System.out.println("A: " + nodeA.toString() + " B: " + nodeB.toString() + " C: " + nodeC.toString());
		outputSubPopFile(nodeA, nodeC, matrixPrime, mutMap, numRows, testName);
...
//			if (nodeAIsLeaf && nodeAParentIsB){
		if (nodeAParentIsB || nodeCParentIsB){
			if (nodeAParentIsB){
				...
				Integer newNodeA = ExtendNode(nodeA, nodeC, g, matrixPrime, mutMap, testName, redEdgeMap);
				if (newNodeA != null) {
					nodeA = newNodeA;
				}
				...
				Integer newNodeC = ExtendNode(nodeC, nodeA, g, matrixPrime, mutMap, testName, redEdgeMap);
				if (newNodeC != null) {
					nodeC = newNodeC;
				}
...
//		}
	...
	private Integer ExtendNode(Integer currNode,
			...
			Map<String, Double> mutMap, String testName, Map<String, Double> redEdgeMap) {
...
//			((currMutConverted + 0.0) / totalMut ));
	...
	private Integer findABySampleCounts(Map<String, Double> redEdgeMap,
		 ...
		 * Taken out for time testing
		 */
//		System.out.println("Sample Counts: " + sampleCounts.toString());
		Integer nodeA = null;
...
//	}
	...
	private void outputSubPopFile(Integer A, Integer B,
			ArrayList<ArrayList<Integer>> matrixPrime,
			Map<String, Double> mutMap, int numRows, String testName) {
		// TODO Auto-generated method stub
...
//		System.out.println("SubPop: " + subPopStr + " NumRows: " + numRows);
		...
		Double subPopNum = mutMap.get(subPopStr);
...
//		pw.close();
	...
	private Integer descendAncestor(Integer nodeA, Integer nodeB, Set<Integer> ancestors, Set<String> redEdges, 
			ArrayList<ArrayList<Integer>> matrixPrime, Map<Integer, Double> subPopCounts, DirectedGraph<Integer, Integer> g) {
		// TODO Auto-generated method stub
...
//		
	...
	private Integer findParents(Integer A,
			Map<String, Double> redEdgeMap, Map<Integer, Double> subPopCounts, Set<Integer> ancestors, DirectedGraph<Integer, Integer> g) {
...
//		System.out.println(score);
	...
	private double getScore(ArrayList<Integer> scoringRoots, Map<Integer, Double> subPopCounts, DirectedGraph<Integer, Integer> g) {
...
//		System.out.println(allScoringNodes.toString());
	...
	private Integer findA(Map<Integer, Double> subPopCounts,
		...
		double max = 0.0;
		Integer A = null;
		for (Map.Entry<Integer, Double> entry: subPopCounts.entrySet()){
	...
	//Fixed?
	private Map<Integer, Double> distributeRedEdges(Map<String, Double> redEdgeMap,
...
//		System.out.println("Red Edge Codes: " + redEdgeMap.toString());
		...
		Map<Integer, Double> subPopCounts = new HashMap<Integer, Double>();
...
//			System.out.println(rightEdgeNode);
	...
	private void removeBadRedEdges(Map<String, Double> redEdgeMap, int numEdges,
			int totalMutations) {
...
//		System.out.println("Threshold: " + threshold);
	...
	private int totalMutations(Map<String, Double> mutMap) {
		// TODO Auto-generated method stub
		ArrayList<Double> values = new ArrayList<Double>(mutMap.values());
		Double total = 0.0;
